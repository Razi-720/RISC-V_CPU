...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , DM_Mask_Out{vlSymsp->TOP.DM_Mask_Out}
    , DM_WrEn_Out{vlSymsp->TOP.DM_WrEn_Out}
    , Instruction_In{vlSymsp->TOP.Instruction_In}
    , Instr_Addr_Out{vlSymsp->TOP.Instr_Addr_Out}
    , DM_Data_In{vlSymsp->TOP.DM_Data_In}
    , DM_Addr_Out{vlSymsp->TOP.DM_Addr_Out}
    , DM_Data_Out{vlSymsp->TOP.DM_Data_Out}
    , rootp{&(vlSymsp->TOP)}
{
