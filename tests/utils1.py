...
class TestProgramGenerator:
    ...
    def generate_arithmetic_test() -> List[int]:
        ...
        return [
            ...
            factory.create_add(3, 1, 2),        # x3 = x1 + x2
            factory.create_sub(4, 2, 1),        # x4 = x2 - x1
            factory.create_addi(5, 3, -5),      # x5 = x3 - 5
        ]
    ...
    def generate_memory_test() -> List[int]:
        ...
        factory = RV32IInstructionFactory()
        return [
            factory.create_addi(1, 0, 0x100),   # x1 = base address
            factory.create_addi(2, 0, 0x42),    # x2 = test data
            factory.create_sw(1, 2, 0),         # store x2 to [x1]
            factory.create_lw(3, 1, 0),         # load [x1] to x3
    ...
    def generate_branch_test() -> List[int]:
        ...
        return [
            ...
            factory.create_beq(1, 2, 8),        # if x1 == x2, jump +8
    ...
    def generate_hazard_test() -> List[int]:
        ...
        return [
            factory.create_addi(1, 0, 10),      # x1 = 10
            factory.create_add(2, 1, 1),        # x2 = x1 + x1 (RAW hazard)
            factory.create_add(3, 2, 1),        # x3 = x2 + x1 (RAW hazard)
            factory.create_sub(4, 3, 2),        # x4 = x3 - x2 (RAW hazard)
        ]
